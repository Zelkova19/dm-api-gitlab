...
async def test_delete_v1_account_login_all_auth(auth_account_helper: AccountHelper) -> None:
    with check_status_code_http():
        await auth_account_helper.dm_account_api.login_api.v1_account_login_all_delete(x_dm_auth_token="")
...
async def test_delete_v1_account_login_all_no_auth(account_helper: AccountHelper) -> None:
    with check_status_code_http(
        ...
        await account_helper.dm_account_api.login_api.v1_account_login_all_delete_with_http_info(x_dm_auth_token="")
