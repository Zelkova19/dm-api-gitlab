...
class AccountApi:
    ...
    async def activate(
        ...
        x_dm_auth_token: Annotated[Optional[StrictStr], Field(description="Authenticated requests require X-Dm-Auth-Token header. You can get the data from POST /account/ method, sending login and password in \"token\" response field")] = None,
